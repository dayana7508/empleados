...
select nombre,( presupuesto - gastos) as presupuesto_final from departamento;
...
select nombre, presupuesto from departamento where presupuesto > 100000 and < 200000;
